...
1. Resolve the canonical provider page, version, DOI or stable identifier.
...
7. Use `scripts/dataset_fetch.py` only after license acceptance. Store raw data under the ignored `data/raw` path.
