...
- `style/academic-style-audit.json` generated by `scripts/academic_style.py`, passing and hash-matched to the current manuscript source tree. Resolve stock phrasing, mechanical transitions, repeated openings/sentences and excessive sentence-length patterns without changing scientific meaning, numbers, equations, citations or uncertainty. This is a writing-quality control, not an AI-authorship detector or evasion tool.
