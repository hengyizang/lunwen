...
class ResultsValidationTests(unittest.TestCase):
    def test_registry_and_claims_form_a_current_evidence_chain(self)->None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            plan={"status":"ready_for_review","runs":[{"run_id":"r1","paper_id":"P01","argv":["python3","analysis.py"],"cwd":".","seed":1,"timeout_seconds":60,"estimated_cost_usd":0,"isolation":{"kind":"host"},"inputs":[],"expected_outputs":["results/metrics.json"]}]}
            ...
            registry=[{"schema_version":"1.0","run_id":"r1","attempt_id":"r1-attempt-001","paper_id":"P01","started_at":"2026-01-01T00:00:00+00:00","finished_at":"2026-01-01T00:00:01+00:00","runtime_seconds":1,"status":"succeeded","argv":["python3","analysis.py"],"cwd":".","seed":1,"timeout_seconds":60,"timed_out":False,"estimated_cost_usd":0.0,"inputs":[],"input_integrity":{"verified_after_run":True,"passed":True,"mutated_or_missing":[]},"approved_plan_sha256":plan_hash,"outputs":[{"path":"results/metrics.json","sha256":output_hash}],"missing_outputs":[]}]
