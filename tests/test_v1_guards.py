...
class V1GuardTests(unittest.TestCase):
    def test_jcr_rejects_if_not_above_one(self):
        payload = {
            "database": "Clarivate Journal Citation Reports", "verification_year": 2026,
            "impact_factor": 1.0, "quartile": "Q1", "category": "Engineering, Mechanical",
            "indexing": "SCIE", "source_url": "https://example.org/jcr", "verified_by": "tester",
            "verified_at": "2026-08-18T00:00:00+00:00",
        }
        with self.assertRaises(ResearchCtlError): verify_payload(payload)

    def test_jcr_rejects_q2_even_with_high_if(self):
        payload = {
            "database": "Clarivate Journal Citation Reports", "verification_year": 2026,
            "impact_factor": 9.9, "quartile": "Q2", "category": "Engineering, Mechanical",
            "indexing": "SCIE", "source_url": "https://example.org/jcr", "verified_by": "tester",
            "verified_at": "2026-08-18T00:00:00+00:00",
        }
        with self.assertRaises(ResearchCtlError): verify_payload(payload)
    ...
    def test_jcr_accepts_q1_with_if_above_one(self):
        payload = {
            "database": "Clarivate Journal Citation Reports", "verification_year": 2026,
            "impact_factor": 1.01, "quartile": "Q1", "category": "Engineering, Mechanical",
            "indexing": "SCIE", "source_url": "https://example.org/jcr", "verified_by": "tester",
            "verified_at": "2026-08-18T00:00:00+00:00",
        }
